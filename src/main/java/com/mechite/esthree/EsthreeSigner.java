 ...
 * This can be created using the static {@link #create} method.
 */
public interface EsthreeSigner {
	...
	/**
	 * Create an instance of {@link EsthreeSigner}.
	 * <p>
	 * The provided region is usually ignored by non-AWS S3 implementations, so it
	 * is a good practice to use {@link Esthree.Region#US_EAST_1}, unless using AWS.
	 */
